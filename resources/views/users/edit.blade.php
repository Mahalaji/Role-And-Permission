    ...
    <div class="row">
        ...
        <div class="input-group">
            ...
            <select id="department_id" name="department_id">
                ...
                {{ isset($user->department_id) && $user->department_id == $department->id ? 'selected' : '' }}>{{ $department->departmentname }}
                </option>
                @endforeach
            </select>
        </div>
    ...
    <select id="designation_id" name="designation_id">
        ...
        @foreach($designation as $designations)
            <option value="{{ $designations->id }}" 
                {{ isset($user->designation_id) && $user->designation_id == $designations->id ? 'selected' : '' }}>
        ...
        <div class="input-group">
            ...
            <select id="roles[]" name="roles[]" >
                ...
                <option value="{{ $value }}" {{ isset($userRole[$value]) ? 'selected' : ''}}>{{ $label }}
                </option>
                @endforeach
            </select>
        </div>
