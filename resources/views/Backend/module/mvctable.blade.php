...
<script>
    ...
    function submitSelect2Data() {
        ...
        if (method === 'table') {
            configuration.table = document.getElementById('tableDropdown').value;
            configuration.column = document.getElementById('columnsDropdown').value;
            ...
            configuration.key = document.getElementById('keyInput').value;
            configuration.value = document.getElementById('valueInput').value;
