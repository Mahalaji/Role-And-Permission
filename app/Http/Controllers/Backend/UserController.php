...
class UserController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('Backend.users.create', compact('roles', 'departments', 'designation'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('Backend.users.edit', compact('user', 'roles', 'userRole', 'departments', 'designation'));
    }
